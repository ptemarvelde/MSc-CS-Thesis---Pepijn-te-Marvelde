...
\begin{abstract}
    ...
    Through an empirical study, an ML-based cost estimator is developed that can accurately predict the faster training method for a wide variety of scenarios. This estimator outperforms state-of-the-art methods in both GPU and CPU scenarios, including scenarios with novel, real-world datasets and hardware settings on which the estimator is not trained.
\end{abstract}
