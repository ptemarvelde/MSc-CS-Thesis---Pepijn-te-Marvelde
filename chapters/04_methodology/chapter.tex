...
\begin{table}[t]
    ...
    \begin{tabular}{p{0.25\linewidth}p{0.45\linewidth}p{0.15\linewidth}}
        \toprule
        Independent Variable         & Explanation                                                      & Reason for choice                                                                     \\ \midrule \midrule
        Sparsity $e$                 & Fraction of zero-valued elements                                 & \cite{MorpheusFIEnablingOptimizingNonlinear2019, morpheus, schijndel_cost_estimation} \\
        Table Size                   & Dimensions of tables. Both Target and Source.                    &                                                                                       \\
        Tuple \& feature ratio       & Ratio of rows/columns from $S_{1\cdots k}$ in $T$ $\tau$, $\rho$ & \cite{morpheus}                                                                       \\
        \todo{Detail all data chars} &                                                                  &                                                                                       \\\bottomrule
    \end{tabular}
