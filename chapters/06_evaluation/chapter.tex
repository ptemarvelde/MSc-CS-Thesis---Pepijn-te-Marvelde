...
\begin{figure}
  ...
  \caption[TPCx-AI dataset sizes for different scale factors.]{TPCx-AI dataset sizes for different scale factors. \todo{Update legend and use different colors for Use case 10, and add more chars?}}
...
\todo{Should also show the performance on synth data?}
