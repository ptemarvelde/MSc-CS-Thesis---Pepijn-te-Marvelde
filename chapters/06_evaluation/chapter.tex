...
Whereas the previous chapter described the process of developing four types of cost models, and evaluated how they compared in terms of performance. This chapter extends this evaluation by comparing our best performing cost models with the SOTA, in \autoref{sec:eval-model-evaluation}, and we add a discussion on generalizability of our best cost model, as well as a thorough analysis of the results. We finish with a critical perspective on the implications and constraints of this research in \autoref{sec:eval-discussion}. Prior to that, the methodology for collecting results is detailed in \autoref{sec:6experiment-setup}.
