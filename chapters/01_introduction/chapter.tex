...
\begin{figure}[h]
    ...
    \caption{\textbf{Running Example: Source datasets and the joined table} Illustration of input data used for Factorized Learning vs. Learning over Materialized data, schema from TPCx-AI \cite{tpcx-ai} Use case 1 (unused columns not shown). Target redundancy avoided by factorization shown in orange.}
