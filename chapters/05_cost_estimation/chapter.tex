...
\begin{table}[ht]
    ...
    \begin{tabular}{p{0.2\linewidth}p{0.45\linewidth}p{0.35\linewidth}}
        ...
        \texttt{FLOPs}                            & $\frac{\texttt{compute\_throughput\_weighted\_mean}}{100} \times \text{\small{gpu\_processing\_power\_double\_precision}}$ & Total number of FLOPs executed in the scenario.                                                                                                   \\
