...
\todo{smth about complexity, smth about bytes read, split paragraph.}

\todo{No hardware chars as the split is made earlier (only concern GPU), apparently diffs between gpu are less important.}
